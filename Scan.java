...
// QUESTION 3:  What does the following case and the code in it do?
	...
	if (str.equals("break"))     return TK.BREAK; 	//part16

	if (str.equals("skip"))     return TK.SKIP; 	//part11
	if (str.equals("stop"))     return TK.STOP; 	//part12
	if (str.equals("mod"))     return TK.MODULO; 	//part14
 	if (str.equals("max"))     return TK.MAX; 	//part15
	if (str.equals("dump"))     return TK.DUMP;	//part17,part18
	if (str.equals("EXCNT"))    return TK.EXCNT;
